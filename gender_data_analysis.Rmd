...
n_assos_type <- data_frame(type_organization, n_assos)
...
ggsave("motivations_figure.png", plot = last_plot())
```
...
assoc_scale_summary <- gender_raw %>% 
  select("Type of Association"= type_organization, Leadership = leadership, Entrepreneurship = entrepreneurship, "Participation in Activities" = activities, Trust = trust, "Compliance" = norms, "Social Capital" = soc_cap_mean) %>% 
